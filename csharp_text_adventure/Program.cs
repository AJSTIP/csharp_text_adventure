...
namespace csharp_text_adventure
{
    class Program
    {
        ...
        public static void movingWrds()
        {
            string welTtl = @"
                    ...
                    (______/ (_______/\_______)(_______/|/   \__/   )_(   (_______/(______/ 
                    ...
                    |/       (_______)|/   \__/(_______/\_______)   )_(   
                                                                     ";
            foreach (var character in welTtl)
            {
        ...
        {
            Console.WriteLine("Greetings and Welcome New Player To the The Deserted Forest Text Adventure.");
                ...
                default:
                    {
                        ...
                        Console.WriteLine("You Have Typed a Command that is invalid... :(");
        ...
        public static void second()
        {
            ...
            Console.WriteLine("Please Type Yes or No / Y or N");
            Console.Write("Choice: ");
